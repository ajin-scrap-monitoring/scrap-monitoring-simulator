...
impl PositiveRatio {
    fn from_decimal_f64s(numerator: f64, denominator: f64) -> Option<Self> {
    ...
    fn ceil_multiple(&self, multiplier: u64) -> Option<u64> {
    ...
    fn reciprocal_multiple_to_f64(&self, multiplier: u64) -> Option<f64> {
        if multiplier == 0 {
            return Some(0.0);
        }
